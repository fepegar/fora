...
------------ | ------------- | ------------- | -------------
**allowed_training_algorithms** | Option<[**Vec<models::RegressionModels>**](RegressionModels.md)> | Allowed models for regression task. | [optional]
**blocked_training_algorithms** | Option<[**Vec<models::RegressionModels>**](RegressionModels.md)> | Blocked models for regression task. | [optional]

...
**metric_thresholds** | [**Vec<models::DataQualityMetricThresholdBase>**](DataQualityMetricThresholdBase.md) | [Required] A list of metrics to calculate and their associated thresholds. | 

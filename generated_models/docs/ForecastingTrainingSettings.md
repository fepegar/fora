...
------------ | ------------- | ------------- | -------------
**allowed_training_algorithms** | Option<[**Vec<models::ForecastingModels>**](ForecastingModels.md)> | Allowed models for forecasting task. | [optional]
**blocked_training_algorithms** | Option<[**Vec<models::ForecastingModels>**](ForecastingModels.md)> | Blocked models for forecasting task. | [optional]

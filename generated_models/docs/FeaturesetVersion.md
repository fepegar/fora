...
------------ | ------------- | ------------- | -------------
**entities** | Option<**Vec<String>**> | Specifies list of entities | [optional]
**materialization_settings** | Option<[**models::MaterializationSettings**](MaterializationSettings.md)> |  | [optional]
**provisioning_state** | Option<[**models::AssetProvisioningState**](AssetProvisioningState.md)> |  | [optional]
**specification** | Option<[**models::FeaturesetSpecification**](FeaturesetSpecification.md)> |  | [optional]
**stage** | Option<**String**> | Specifies the asset stage | [optional]

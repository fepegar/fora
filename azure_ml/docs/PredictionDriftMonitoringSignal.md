...
**metric_thresholds** | [**Vec<models::PredictionDriftMetricThresholdBase>**](PredictionDriftMetricThresholdBase.md) | [Required] A list of metrics to calculate and their associated thresholds. | 

...
------------ | ------------- | ------------- | -------------
**component_spec** | Option<[**serde_json::Value**](.md)> | Defines Component definition details.  <see href=\"https://docs.microsoft.com/en-us/azure/machine-learning/reference-yaml-component-command\" /> | [optional]

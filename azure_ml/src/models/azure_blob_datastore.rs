...
pub struct AzureBlobDatastore {
    ...
    #[serde(rename = "containerName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl AzureBlobDatastore {
    ...
    pub fn new(credentials: models::DatastoreCredentials, datastore_type: models::DatastoreType) -> AzureBlobDatastore {
        AzureBlobDatastore {
            account_name: None,
            container_name: None,
            endpoint: None,

...
impl OneLakeDatastore {
    ...
    pub fn new(artifact: models::OneLakeArtifact, one_lake_workspace_name: String, credentials: models::DatastoreCredentials, datastore_type: models::DatastoreType) -> OneLakeDatastore {
        OneLakeDatastore {

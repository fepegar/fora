...
impl AzureDataLakeGen2Datastore {
    ...
    pub fn new(account_name: String, filesystem: String, credentials: models::DatastoreCredentials, datastore_type: models::DatastoreType) -> AzureDataLakeGen2Datastore {

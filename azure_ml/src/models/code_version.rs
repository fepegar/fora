...
pub struct CodeVersion {
    ...
    #[serde(rename = "codeUri", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub code_uri: Option<Option<String>>,

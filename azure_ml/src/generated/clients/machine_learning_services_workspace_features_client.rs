...
use crate::generated::models::{
    ListAmlUserFeatureResult, MachineLearningServicesWorkspaceFeaturesClientListOptions,
};
use azure_core::{
...
#[tracing::client]
pub struct MachineLearningServicesWorkspaceFeaturesClient {
...
impl MachineLearningServicesWorkspaceFeaturesClient {
    ...
    #[tracing::function("Microsoft.MachineLearningServices.Workspaces.list")]
    pub fn list(
        &self,
        resource_group_name: &str,
        workspace_name: &str,
        options: Option<MachineLearningServicesWorkspaceFeaturesClientListOptions<'_>>,
    ) -> Result<Pager<ListAmlUserFeatureResult>> {
        ...
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/features");
        ...
        Ok(Pager::new(
            move |next_link: PagerState, pager_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: ListAmlUserFeatureResult = json::from_json(&body)?;

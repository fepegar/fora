...
use crate::generated::models::{
    MachineLearningServicesPrivateLinkResourcesClientListOptions, PrivateLinkResourceListResult,
};
use azure_core::{
...
#[tracing::client]
pub struct MachineLearningServicesPrivateLinkResourcesClient {
...
impl MachineLearningServicesPrivateLinkResourcesClient {
    ...
    #[tracing::function("Microsoft.MachineLearningServices.Workspaces.privateLinkResourcesList")]
    pub fn list(
        &self,
        resource_group_name: &str,
        workspace_name: &str,
        options: Option<MachineLearningServicesPrivateLinkResourcesClientListOptions<'_>>,
    ) -> Result<Pager<PrivateLinkResourceListResult>> {
        ...
        let mut path = String::from("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/privateLinkResources");
        ...
        Ok(Pager::new(
            move |next_link: PagerState, pager_options| {
                ...
                Box::pin(async move {
                    ...
                    let res: PrivateLinkResourceListResult = json::from_json(&body)?;

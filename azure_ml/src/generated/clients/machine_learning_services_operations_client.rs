...
use crate::generated::models::{
    MachineLearningServicesOperationsClientListOptions, OperationListResult,
};
use azure_core::{
...
#[tracing::client]
pub struct MachineLearningServicesOperationsClient {
    pub(crate) api_version: String,
    pub(crate) endpoint: Url,
    pub(crate) pipeline: Pipeline,
}

impl MachineLearningServicesOperationsClient {
    ...
    pub fn list(
        &self,
        options: Option<MachineLearningServicesOperationsClientListOptions<'_>>,
    ) -> Result<Pager<OperationListResult>> {
        let options = options.unwrap_or_default().into_owned();
        let pipeline = self.pipeline.clone();
        let mut first_url = self.endpoint.clone();
        first_url.append_path("/providers/Microsoft.MachineLearningServices/operations");
